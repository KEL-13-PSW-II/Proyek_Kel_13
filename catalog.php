<?php
  $koneksi = mysqli_connect("localhost","root","","local_side");
?>
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
          <div class="navbar-nav ml-auto">
            ...
            <a class="nav-item nav-link active" href="catalog.php">
    ...
    <div class="row container conta">
      <div class="col-md-6">
        <div class="card">
          ...
          <div class="card-body">
            <?php
              $sql1 = mysqli_query($koneksi, "SELECT * FROM catalog WHERE id='1'");
              $data = mysqli_fetch_array($sql1);
            ?>
            <h5 class="card-title"><img class="gambar" src="gambar/wanita1.jpg" alt=""></h5>
            <p class="card-text"><?= $data['nama'];?></p>
            <a href="" id="deskripsi" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#exampleModal1">Deskripsi</a>
            <a href="payment.php" class="btn btn-danger">Pesan</a>
          </div>
        </div>
      </div>
      <div class="col-md-6">
        <div class="card">
          ...
          <div class="card-body">
            <?php
              $sql2 = mysqli_query($koneksi, "SELECT * FROM catalog WHERE id='2'");
              $data = mysqli_fetch_array($sql2);
            ?>
            <h5 class="card-title"><img class="gambar" src="gambar/pria1.jpg" alt=""></h5>
            <p class="card-text"><?= $data['nama'];?></p>
            <a href="#" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#exampleModal2">Deskripsi</a>
            <a href="payment.php" class="btn btn-danger">Pesan</a>
          </div>
        </div>
      </div>
    ...
    <div class="row container conta">
      <div class="col-md-6">
        <div class="card">
          ...
          <div class="card-body">
            <?php
              $sql3 = mysqli_query($koneksi, "SELECT * FROM catalog WHERE id='3'");
              $data = mysqli_fetch_array($sql3);
            ?>
            <h5 class="card-title"><img class="gambar" src="gambar/wanita2.jpg" alt=""></h5>
            <p class="card-text"><?= $data['nama'];?></p>
            <a href="#" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#exampleModal3">Deskripsi</a>
            <a href="payment.php" class="btn btn-danger">Pesan</a>
          </div>
        </div>
      </div>
      <div class="col-md-6">
        <div class="card">
          ...
          <div class="card-body">
            <?php
              $sql4 = mysqli_query($koneksi, "SELECT * FROM catalog WHERE id='4'");
              $data = mysqli_fetch_array($sql4);
            ?>
            <h5 class="card-title"><img class="gambar" src="gambar/pria2.jpg" alt=""></h5>
            <p class="card-text"><?= $data['nama'];?></p>
            <a href="#" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#exampleModal4">Deskripsi</a>
            <a href="payment.php" class="btn btn-danger">Pesan</a>
          </div>
        </div>
      </div>
...
<!-- Modal -->
<?php
  $sql1 = mysqli_query($koneksi, "SELECT * FROM catalog WHERE id='2'");
  $data = mysqli_fetch_array($sql1);
?>
...
<!-- Modal -->
<?php
  $sql1 = mysqli_query($koneksi, "SELECT * FROM catalog WHERE id='3'");
  $data = mysqli_fetch_array($sql1);
?>
...
<!-- Modal -->
<?php
  $sql1 = mysqli_query($koneksi, "SELECT * FROM catalog WHERE id='4'");
  $data = mysqli_fetch_array($sql1);
?>
