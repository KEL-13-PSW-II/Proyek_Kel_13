...
class BookController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('book')->with('status','Data Produk berhasil ditambah!!');
    }
    ...
    public function update(Request $request, Book $book)
    {
        ...
        return redirect()->route('book.index')->with('status','Data Produk berhasil diubah');
    }
    ...
    public function destroy(Book $book)
    {
        ...
        $book->delete();
        return redirect()->route('book.index')->with('status','Data Produk berhasil dihapus');
    }
}