...
<html lang="en">
  ...
  <body style="background-color: white (105, 128, 148);">
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
          <div class="navbar-nav ml-auto">
            ...
            <a class="nav-item nav-link" href="catalog.html">
    ...
    <table class="table table-dark table-striped">
        ...
        <tr>
            <td><center><iframe src="https://goo.gl/maps/fMzipVDeRiKSPw3SA" width="600" height="450" frameborder="2" style="border:2;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe></center></td>
        </tr>
        <tr>
            <td>Whatsapp : 0895-3460-5227</td>
        </tr>
        <tr>
            <th>localside@gmail.com</th>
        </tr>
        <tr>
            <th>@localside</th>
        </tr>
