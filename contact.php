...
<html lang="en">
  ...
  <body style="background-color: white (105, 128, 148);">
    ...
    <div class="grid-container">
        ...
        <form action="login.php" method="post" enctype="multipart/form-data" width="50%">
            <fieldset>
            ...
            <a href="" id="deskripsi" class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#exampleModal1">Kirim</a>
            </div>
            </div>
            </fieldset>
            </form>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        // $res = $c->query("SELECT id_barang, gambar, nama_barang, format(harga, 0) as harga_f, ifnull(diskon, 0) diskon From barang") 
        //     or die($mysqli->error);      
        echo $nama." Tanggapan anda telah direkam";
        ?>
